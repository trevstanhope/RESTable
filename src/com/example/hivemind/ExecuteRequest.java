...
/*
 * Specialized Intent for RestService
 */
public class ExecuteRequest extends IntentService {
	...
	/*
	 * Overrides onHandleIntent for RestService Class
    ...
    public void executeDelete(String deletePath) throws Exception {
		...
		for(NameValuePair h : headers) {
			request.addHeader(h.getName(), h.getValue()); // Add Headers
		}
		commit();
	}
    
	/*
	 * Executes Request for a RestService as Intent.
	 */
	...
	/*
	 * Converts Binary Stream to String.
	 */
